...
$( function()
{
	...
	$.widget( 'jqueryDash.rssPanel', $.jqueryDash.panel, {
		...
		{
			this._super();
			this._addEditorField( 'bool', 'showItemTitle', (this.options.showItemTitle ? 1 : 0), 'Display Title' );
			this._addEditorField( 'text', 'url', this.options.url, 'Source URL' );
			this._addEditorField( 'text', 'maxEntries', this.options.maxEntries, 'Max Entries' );
